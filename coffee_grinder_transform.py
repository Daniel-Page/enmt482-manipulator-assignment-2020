...
base_X_vector = [1, 0, 0] # Unit vector in the positive x direction of the base
dspmt_xy_vector = [float(dspmt_vector[0]), float(dspmt_vector[1]) , 0] # The displacement in terms of x and y
