...
grinder.crank_grinder_lever(robot, 100)                   # 11. Crank the lever [arg 2] degrees, then returns to its previous position
...
grinder.grinder_portafilter_reapprch(robot)               # 15.
grinder.reattach_portafilter(robot, RDK, world_frame)     # 16.
tamper.grinder_stand_to_tamper(robot)                     # 17.
tamper.scrape_portafilter(robot)                          # 18.
tamper.crush_portafilter(robot)                           # 19.
coffee_machine.tamper_to_coffee_machine(robot, 2)         # 20.
cup.portafilter_handover_to_cup_tool(robot)               # 21.
cup.attach_cup_tool(robot, RDK, world_frame, master_tool) # 22.
...
coffee_machine.coffee_switch(robot)                       # 29.
coffee_machine.tamper_to_coffee_machine(robot, 10)        # 30.
'''
