...
one = meshfile('coffee_machine.stl',-359.9-84.09,-387.38-111.08,0,104.8,0.04)

#one = meshfile('coffee_machine.stl',0,0,0,104.8,1)
...
ax2 = axesrgb(-359.9,-387.38,341.24,104.8)
...
fig.add_trace(go.Scatter3d(x=[0,-359.9], y=[0,-387.38], z=[20,341.24], name = 'Low 2014',marker=dict(color='black', size=5),line=dict(color='black', width=9, dash='dash')))
fig.add_trace(go.Scatter3d(x=[0,-573.54], y=[0,-443.66], z=[20,341.24], name = 'Low 2014',marker=dict(color='black', size=5),line=dict(color='black', width=9, dash='dash')))
fig.add_trace(go.Scatter3d(x=[-359.9,-573.54], y=[-387.38,-443.66], z=[341.24,341.24], name = 'Low 2014',marker=dict(color='orange', size=1),line=dict(color='orange', width=9)))
