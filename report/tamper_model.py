...
one = meshfile('tamper.stl',598.1,4.31,0,-59.5,0.1)
...
ax2 = axesrgb(598.1,4.31,225.13+5,-59.5)
...
fig.add_trace(go.Scatter3d(x=[0,598.1], y=[0,4.31], z=[20,225.13+5], name = 'Low 2014',marker=dict(color='black', size=5),line=dict(color='black', width=9, dash='dash')))
fig.add_trace(go.Scatter3d(x=[0,557.5], y=[0,73.18], z=[20,225.13+5-55], name = 'Low 2014',marker=dict(color='black', size=5),line=dict(color='black', width=9, dash='dash')))
fig.add_trace(go.Scatter3d(x=[598.1,557.5], y=[4.31,73.18], z=[225.13+5,225.13+5-55], name = 'Low 2014',marker=dict(color='orange', size=1),line=dict(color='orange', width=9)))
